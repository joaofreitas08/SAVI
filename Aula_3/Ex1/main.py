...
def main():
    ...
    parser.add_argument('-if', '--input_filename', type=str, default='Aula_3/Ex1/traffic.mp4')
    ...
    previous_previous_change_event = False
    previous_previous_previous_change_event == False
    number_of_cars = 0
    frame_count = 0
    while True:
        ...
        if previous_previous_change_event == True and previous_change_event == False and change_event == True:  # a falling edge
            pass  # do nothing
        elif previous_previous_previous_change_event == True and previous_previous_change_event == False and previous_change_event == False and change_event == True:  # a falling edge
            pass  # do nothing
        elif previous_change_event == False and change_event == True:  # a rising edge
            number_of_cars += 1
        
        previous_previous_previous_change_event = previous_previous_change_event
        previous_previous_change_event = previous_change_event
