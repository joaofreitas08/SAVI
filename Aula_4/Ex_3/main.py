...
def main():
    ...
    parser.add_argument('-qi', '--query_image', type=str, default='Aula_4/Ex_3/images/1.png')
    parser.add_argument('-ti', '--target_image', type=str, default='Aula_4/Ex_3/images/2.png')
    ...
    # Draw the matches
    match_image = cv2.drawMatches(q_image, q_key_points, t_image, t_key_points,
                                  matches, None,
                                  flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
    matched_image = cv2.resize(match_image, (1920, 1080))
