...
def main():
    ...
    parser.add_argument('-qi', '--query_image', type=str, default='Aula_4/Ex4/images/1machu.png')
    parser.add_argument('-ti', '--target_image', type=str, default='Aula_4/Ex4/images/2machu.png')
    ...
    matched_image = cv2.resize(image_matches, (1920, 1080))

    win_name = 'matches_image'
    cv2.namedWindow(win_name, cv2.WINDOW_NORMAL)
    cv2.imshow(win_name, matched_image)  # type: ignore
